...
.Java
----
	public class com.vilderlee.spring.condition.Main {
...
of the `com.vilderlee.spring.condition.Main` class has a reference to the proxy. This means that method calls on that
...
----
	...
	public final class com.vilderlee.spring.condition.Main {

		public static void main(String[] args) {
			ApplicationContext ctx = new ClassPathXmlApplicationContext("beans.xml", com.vilderlee.spring.condition.Main.class);
...
We use the following command to run the `com.vilderlee.spring.condition.Main` class shown earlier:

[literal,subs="verbatim,quotes"]
----
java -javaagent:C:/projects/foo/lib/global/spring-instrument.jar foo.com.vilderlee.spring.condition.Main
----
...
The output from the execution of the `com.vilderlee.spring.condition.Main` program looks something like the next example.
...
Spring beans. The following slight variation on the `com.vilderlee.spring.condition.Main` program yields the same
result:
...
----
	...
	public final class com.vilderlee.spring.condition.Main {
		...
		public static void main(String[] args) {
			new ClassPathXmlApplicationContext("beans.xml", com.vilderlee.spring.condition.Main.class);
